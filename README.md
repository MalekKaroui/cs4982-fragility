...
**Note:** Streamlit layout warnings are cosmetic and can be ignored.

---

## References

1. Buldyrev, S. et al. (2010). Catastrophic cascade of failures in interdependent networks. *Nature*.

2. Gao, J. et al. (2016). Universal resilience patterns in complex networks. *Nature*.

3. Helbing, D. (2013). Globally networked risks and how to respond. *Nature*.

4. Motter, A. & Lai, Y.-C. (2002). Cascade-based attacks on complex networks. *Physical Review E*.

5. Watts, D. (2002). A simple model of global cascades on random networks. *PNAS*.

6. World Bank (2024). Global Supply Chain Stress Index.

7. SupplyGraph Dataset (2024). CIOL Research Lab.

8. IEEE DataPort (2024). PowerCascade Dataset.
...
This project is for academic purposes as part of CS4982 Senior Project at the University of New Brunswick (Saint John).
